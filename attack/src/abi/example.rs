...
```*/
    ...
    ///Container for all the [`Example`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ExampleCalls {
        const NAME: &'static str = "ExampleCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ExampleCalls>] = &[
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<ExampleCalls> {
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ExampleCalls::owner)
                    }
                    owner
                },
            ];
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ExampleCalls>] = &[
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<ExampleCalls> {
    ...
    /**Creates a new wrapper around an on-chain [`Example`](self) contract instance.

See the [wrapper's documentation](`ExampleInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        ExampleInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ExampleInstance<P, N>>,
    > {
        ExampleInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ExampleInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`Example`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`Example`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ExampleInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ExampleInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ExampleInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ExampleInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ExampleInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ExampleInstance<P, N> {
            ExampleInstance {
