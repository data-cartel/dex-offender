    ...
    impl<M: ::ethers::providers::Middleware> GatekeeperOneClone<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                GATEKEEPERONECLONE_ABI.clone(),
                GATEKEEPERONECLONE_BYTECODE.clone().into(),
                client,
            );
