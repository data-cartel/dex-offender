...
pub mod crypto_vault {
    ...
    pub static CRYPTOVAULT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M: ::ethers::providers::Middleware> CryptoVault<M> {
        ...
        ///Calls the contract's `setUnderlying` (0xbdb2321f) function
        ...
        ///Calls the contract's `sweepToken` (0x1be19560) function
        pub fn sweep_token(
            &self,
        ...
        ///Calls the contract's `sweptTokensRecipient` (0x3234a197) function
    ...
    ///Container type for all input parameters for the `setUnderlying` function with signature `setUnderlying(address)` and selector `0xbdb2321f`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `sweepToken` function with signature `sweepToken(address)` and selector `0x1be19560`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `sweptTokensRecipient` function with signature `sweptTokensRecipient()` and selector `0x3234a197`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for CryptoVaultCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SetUnderlyingCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for CryptoVaultCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::SetUnderlying(element) => ::core::fmt::Display::fmt(element, f),
    ...
    ///Container type for all return fields from the `sweptTokensRecipient` function with signature `sweptTokensRecipient()` and selector `0x3234a197`
    #[derive(
        Clone,
