...
pub mod delegate {
    ...
    impl<M> ::core::fmt::Debug for Delegate<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Delegate)).field(&self.address()).finish()
        }
    }
