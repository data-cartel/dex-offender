...
pub mod denial {
    ...
    impl<M> ::core::fmt::Debug for Denial<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Denial)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Denial<M> {
        ...
        ///Calls the contract's `contractBalance` (0x8b7afe2e) function
        ...
        ///Calls the contract's `partner` (0xbe10862b) function
        pub fn partner(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
            M,
        ...
        ///Calls the contract's `setWithdrawPartner` (0x4e1c5914) function
    ...
    ///Container type for all input parameters for the `contractBalance` function with signature `contractBalance()` and selector `0x8b7afe2e`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `partner` function with signature `partner()` and selector `0xbe10862b`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setWithdrawPartner` function with signature `setWithdrawPartner(address)` and selector `0x4e1c5914`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for DenialCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <ContractBalanceCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SetWithdrawPartnerCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for DenialCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::Partner(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for DenialCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::ContractBalance(element) => ::core::fmt::Display::fmt(element, f),
    ...
    ///Container type for all return fields from the `contractBalance` function with signature `contractBalance()` and selector `0x8b7afe2e`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `partner` function with signature `partner()` and selector `0xbe10862b`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
