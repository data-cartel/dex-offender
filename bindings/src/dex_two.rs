...
pub mod dex_two {
    ...
    impl<M> ::core::fmt::Debug for DexTwo<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DexTwo)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DexTwo<M> {
        ...
        ///Calls the contract's `add_liquidity` (0x264e8893) function
        ...
        ///Calls the contract's `getSwapAmount` (0x635bc0c2) function
    ...
    ///Container type for all input parameters for the `add_liquidity` function with signature `add_liquidity(address,uint256)` and selector `0x264e8893`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `getSwapAmount` function with signature `getSwapAmount(address,address,uint256)` and selector `0x635bc0c2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "getSwapAmount", abi = "getSwapAmount(address,address,uint256)")]
    ...
    impl ::ethers::core::abi::AbiDecode for DexTwoCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <GetSwapAmountCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for DexTwoCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::GetSwapAmount(element) => ::core::fmt::Display::fmt(element, f),
    ...
    ///Container type for all return fields from the `getSwapAmount` function with signature `getSwapAmount(address,address,uint256)` and selector `0x635bc0c2`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
