...
pub mod engine {
    ...
    pub static ENGINE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for Engine<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Engine)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Engine<M> {
        ...
        ///Calls the contract's `horsePower` (0x564f6d71) function
        pub fn horse_power(
            &self,
    ...
    ///Container type for all input parameters for the `horsePower` function with signature `horsePower()` and selector `0x564f6d71`
    #[derive(
        Clone,
    ...
    impl ::core::fmt::Display for EngineCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::HorsePower(element) => ::core::fmt::Display::fmt(element, f),
    ...
    ///Container type for all return fields from the `horsePower` function with signature `horsePower()` and selector `0x564f6d71`
    #[derive(
        Clone,
