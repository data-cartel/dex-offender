...
pub mod fallback {
    ...
    impl<M> ::core::fmt::Debug for Fallback<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Fallback)).field(&self.address()).finish()
        }
    }
