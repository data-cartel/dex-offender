...
pub mod fallout {
    ...
    pub static FALLOUT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for Fallout<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Fallout)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Fallout<M> {
        ...
        ///Calls the contract's `Fal1out` (0x6fab5ddf) function
        pub fn fal_1out(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([111, 171, 93, 223], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `allocate` (0xabaa9916) function
        pub fn allocate(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([171, 170, 153, 22], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `allocatorBalance` (0xffd40b56) function
        ...
        ///Calls the contract's `collectAllocations` (0x8aa96f38) function
        ...
        ///Calls the contract's `sendAllocation` (0xa2dea26f) function
    ...
    ///Container type for all input parameters for the `Fal1out` function with signature `Fal1out()` and selector `0x6fab5ddf`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `allocate` function with signature `allocate()` and selector `0xabaa9916`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `allocatorBalance` function with signature `allocatorBalance(address)` and selector `0xffd40b56`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `collectAllocations` function with signature `collectAllocations()` and selector `0x8aa96f38`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `sendAllocation` function with signature `sendAllocation(address)` and selector `0xa2dea26f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for FalloutCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SendAllocationCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for FalloutCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::Fal1Out(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for FalloutCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::AllocatorBalance(element) => ::core::fmt::Display::fmt(element, f),
                Self::CollectAllocations(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::Owner(element) => ::core::fmt::Display::fmt(element, f),
                Self::SendAllocation(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    ///Container type for all return fields from the `allocatorBalance` function with signature `allocatorBalance(address)` and selector `0xffd40b56`
    #[derive(
        Clone,
