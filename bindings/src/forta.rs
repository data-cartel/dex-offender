...
pub mod forta {
    ...
    pub static FORTA_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for Forta<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Forta)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Forta<M> {
        ...
        ///Calls the contract's `botRaisedAlerts` (0xdc702fa0) function
        ...
        ///Calls the contract's `usersDetectionBots` (0x9e1083ca) function
    ...
    ///Container type for all input parameters for the `botRaisedAlerts` function with signature `botRaisedAlerts(address)` and selector `0xdc702fa0`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `usersDetectionBots` function with signature `usersDetectionBots(address)` and selector `0x9e1083ca`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for FortaCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <BotRaisedAlertsCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <UsersDetectionBotsCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::core::fmt::Display for FortaCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::BotRaisedAlerts(element) => ::core::fmt::Display::fmt(element, f),
    ...
    ///Container type for all return fields from the `botRaisedAlerts` function with signature `botRaisedAlerts(address)` and selector `0xdc702fa0`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `usersDetectionBots` function with signature `usersDetectionBots(address)` and selector `0x9e1083ca`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
