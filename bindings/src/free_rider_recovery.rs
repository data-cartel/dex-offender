        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("InvalidTokenID"),
                            inputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned("NotEnoughFunding"),
                            inputs: ::std::vec![],
                        },
                    ],
                ),
