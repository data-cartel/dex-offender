...
pub mod i_notifyable {
    ...
    pub static INOTIFYABLE_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M: ::ethers::providers::Middleware> INotifyable<M> {
        ...
        ///Calls the contract's `notify` (0x98d078b4) function
        pub fn notify(
            &self,
    ...
    ///Container type for all input parameters for the `notify` function with signature `notify(uint256)` and selector `0x98d078b4`
    #[derive(
        Clone,
