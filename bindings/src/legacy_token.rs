...
pub mod legacy_token {
    ...
    pub static LEGACYTOKEN_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M: ::ethers::providers::Middleware> LegacyToken<M> {
        ...
        ///Calls the contract's `delegate` (0xc89e4361) function
        pub fn delegate(
            &self,
        ...
        ///Calls the contract's `delegateToNewContract` (0x1d2d8400) function
    ...
    impl ::ethers::contract::EthLogDecode for LegacyTokenEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(LegacyTokenEvents::OwnershipTransferredFilter(decoded));
            }
    ...
    ///Container type for all input parameters for the `delegate` function with signature `delegate()` and selector `0xc89e4361`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `delegateToNewContract` function with signature `delegateToNewContract(address)` and selector `0x1d2d8400`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "delegateToNewContract", abi = "delegateToNewContract(address)")]
    ...
    ///Container type for all return fields from the `delegate` function with signature `delegate()` and selector `0xc89e4361`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
