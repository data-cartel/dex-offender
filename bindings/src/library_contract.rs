...
pub mod library_contract {
    ...
    pub static LIBRARYCONTRACT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    #[rustfmt::skip]
    const __BYTECODE: &[u8] = b"`\x80`@R4\x80\x15`\x0FW`\0\x80\xFD[P`\x8D\x80a\0\x1E`\09`\0\xF3\xFE`\x80`@R4\x80\x15`\x0FW`\0\x80\xFD[P`\x046\x10`(W`\x005`\xE0\x1C\x80c;\xEB&\xC4\x14`-W[`\0\x80\xFD[`=`86`\x04`?V[`\0UV[\0[`\0` \x82\x84\x03\x12\x15`PW`\0\x80\xFD[P5\x91\x90PV\xFE\xA2dipfsX\"\x12 \xD5\xE4a5\xDB\x97\xDD\xFD\xA5\xC6c\x9E\x19\xCC\xDE\xB1_\x06\xA9\xCEC\x02e\xA1\xE7\x08\xCD_<\x1A\x9A\xFEdsolcC\0\x08\x14\x003";
    /// The bytecode of the contract.
    pub static LIBRARYCONTRACT_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    const __DEPLOYED_BYTECODE: &[u8] = b"`\x80`@R4\x80\x15`\x0FW`\0\x80\xFD[P`\x046\x10`(W`\x005`\xE0\x1C\x80c;\xEB&\xC4\x14`-W[`\0\x80\xFD[`=`86`\x04`?V[`\0UV[\0[`\0` \x82\x84\x03\x12\x15`PW`\0\x80\xFD[P5\x91\x90PV\xFE\xA2dipfsX\"\x12 \xD5\xE4a5\xDB\x97\xDD\xFD\xA5\xC6c\x9E\x19\xCC\xDE\xB1_\x06\xA9\xCEC\x02e\xA1\xE7\x08\xCD_<\x1A\x9A\xFEdsolcC\0\x08\x14\x003";
    /// The deployed bytecode of the contract.
    pub static LIBRARYCONTRACT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
