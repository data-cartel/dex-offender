...
pub mod motorbike {
    ...
    impl<M> ::core::fmt::Debug for Motorbike<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Motorbike)).field(&self.address()).finish()
        }
    }
