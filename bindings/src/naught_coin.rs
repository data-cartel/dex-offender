...
pub mod naught_coin {
    ...
    impl<M> ::core::fmt::Debug for NaughtCoin<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(NaughtCoin)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> NaughtCoin<M> {
        ...
        ///Calls the contract's `INITIAL_SUPPLY` (0x2ff2e9dc) function
        ...
        ///Calls the contract's `timeLock` (0xd085835a) function
        pub fn time_lock(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ::ethers::core::types::U256> {
            self.0
    ...
    ///Container type for all input parameters for the `INITIAL_SUPPLY` function with signature `INITIAL_SUPPLY()` and selector `0x2ff2e9dc`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `timeLock` function with signature `timeLock()` and selector `0xd085835a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for NaughtCoinCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <InitialSupplyCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for NaughtCoinCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::InitialSupply(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<InitialSupplyCall> for NaughtCoinCalls {
        fn from(value: InitialSupplyCall) -> Self {
            Self::InitialSupply(value)
        }
    }
    ...
    ///Container type for all return fields from the `INITIAL_SUPPLY` function with signature `INITIAL_SUPPLY()` and selector `0x2ff2e9dc`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `timeLock` function with signature `timeLock()` and selector `0xd085835a`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
