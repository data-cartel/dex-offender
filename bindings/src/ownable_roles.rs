...
pub mod ownable_roles {
    ...
    impl<M> ::core::fmt::Debug for OwnableRoles<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(OwnableRoles)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::contract::EthLogDecode for OwnableRolesEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipHandoverCanceledFilter::decode_log(log) {
                return Ok(OwnableRolesEvents::OwnershipHandoverCanceledFilter(decoded));
            }
            if let Ok(decoded) = OwnershipHandoverRequestedFilter::decode_log(log) {
                return Ok(OwnableRolesEvents::OwnershipHandoverRequestedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(OwnableRolesEvents::OwnershipTransferredFilter(decoded));
            }
    ...
    impl ::core::convert::From<OwnershipHandoverCanceledFilter> for OwnableRolesEvents {
        fn from(value: OwnershipHandoverCanceledFilter) -> Self {
            Self::OwnershipHandoverCanceledFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipHandoverRequestedFilter> for OwnableRolesEvents {
    ...
    impl ::core::convert::From<CompleteOwnershipHandoverCall> for OwnableRolesCalls {
    ...
    impl ::core::convert::From<OwnershipHandoverExpiresAtCall> for OwnableRolesCalls {
        fn from(value: OwnershipHandoverExpiresAtCall) -> Self {
            Self::OwnershipHandoverExpiresAt(value)
        }
    }
    impl ::core::convert::From<OwnershipHandoverValidForCall> for OwnableRolesCalls {
