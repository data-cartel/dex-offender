...
pub mod preservation {
    ...
    impl<M: ::ethers::providers::Middleware> Preservation<M> {
        ...
        ///Calls the contract's `setFirstTime` (0xf1e02620) function
        ...
        ///Calls the contract's `setSecondTime` (0x5bda8fa4) function
        ...
        ///Calls the contract's `timeZone1Library` (0x3dc79422) function
        ...
        ///Calls the contract's `timeZone2Library` (0x27d6974f) function
    ...
    ///Container type for all input parameters for the `setFirstTime` function with signature `setFirstTime(uint256)` and selector `0xf1e02620`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setSecondTime` function with signature `setSecondTime(uint256)` and selector `0x5bda8fa4`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `timeZone1Library` function with signature `timeZone1Library()` and selector `0x3dc79422`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `timeZone2Library` function with signature `timeZone2Library()` and selector `0x27d6974f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for PreservationCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SetFirstTimeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SetFirstTime(decoded));
            }
            if let Ok(decoded)
                = <SetSecondTimeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for PreservationCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SetFirstTime(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetSecondTime(element) => ::core::fmt::Display::fmt(element, f),
                Self::TimeZone1Library(element) => ::core::fmt::Display::fmt(element, f),
                Self::TimeZone2Library(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    ///Container type for all return fields from the `timeZone1Library` function with signature `timeZone1Library()` and selector `0x3dc79422`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `timeZone2Library` function with signature `timeZone2Library()` and selector `0x27d6974f`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
