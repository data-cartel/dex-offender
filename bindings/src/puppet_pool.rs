...
pub mod puppet_pool {
    ...
    impl<M> ::core::fmt::Debug for PuppetPool<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(PuppetPool)).field(&self.address()).finish()
        }
    }
