...
pub mod puzzle_proxy {
    ...
    impl<M: ::ethers::providers::Middleware> PuzzleProxy<M> {
        ...
        ///Calls the contract's `approveNewAdmin` (0xa02fcc0a) function
        ...
        ///Calls the contract's `proposeNewAdmin` (0xa6376746) function
    ...
    ///Container type for all input parameters for the `approveNewAdmin` function with signature `approveNewAdmin(address)` and selector `0xa02fcc0a`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `proposeNewAdmin` function with signature `proposeNewAdmin(address)` and selector `0xa6376746`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for PuzzleProxyCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <ApproveNewAdminCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <ProposeNewAdminCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for PuzzleProxyCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::ApproveNewAdmin(element) => ::core::fmt::Display::fmt(element, f),
                Self::PendingAdmin(element) => ::core::fmt::Display::fmt(element, f),
                Self::ProposeNewAdmin(element) => ::core::fmt::Display::fmt(element, f),
