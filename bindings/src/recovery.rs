...
pub mod recovery {
    ...
    pub static RECOVERY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for Recovery<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Recovery)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Recovery<M> {
        ...
        ///Calls the contract's `generateToken` (0x3894e516) function
    ...
    ///Container type for all input parameters for the `generateToken` function with signature `generateToken(string,uint256)` and selector `0x3894e516`
    #[derive(
        Clone,
