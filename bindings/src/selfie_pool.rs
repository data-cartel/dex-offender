...
pub mod selfie_pool {
    ...
    impl<M> ::core::fmt::Debug for SelfiePool<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SelfiePool)).field(&self.address()).finish()
        }
    }
