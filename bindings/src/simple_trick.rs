...
pub mod simple_trick {
    ...
    pub static SIMPLETRICK_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M: ::ethers::providers::Middleware> SimpleTrick<M> {
        ...
        ///Calls the contract's `checkPassword` (0x9e4b2e47) function
        ...
        ///Calls the contract's `trickInit` (0x4cbb817f) function
        pub fn trick_init(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
                .method_hash([76, 187, 129, 127], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `trickyTrick` (0xb7e00291) function
        pub fn tricky_trick(&self) -> ::ethers::contract::builders::ContractCall<M, ()> {
            self.0
    ...
    ///Container type for all input parameters for the `checkPassword` function with signature `checkPassword(uint256)` and selector `0x9e4b2e47`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `trickInit` function with signature `trickInit()` and selector `0x4cbb817f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `trickyTrick` function with signature `trickyTrick()` and selector `0xb7e00291`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for SimpleTrickCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <CheckPasswordCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TrickyTrickCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for SimpleTrickCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::CheckPassword(element) => ::core::fmt::Display::fmt(element, f),
                Self::Target(element) => ::core::fmt::Display::fmt(element, f),
                Self::Trick(element) => ::core::fmt::Display::fmt(element, f),
                Self::TrickInit(element) => ::core::fmt::Display::fmt(element, f),
                Self::TrickyTrick(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    ...
    impl ::core::convert::From<TrickInitCall> for SimpleTrickCalls {
        fn from(value: TrickInitCall) -> Self {
            Self::TrickInit(value)
        }
    }
    impl ::core::convert::From<TrickyTrickCall> for SimpleTrickCalls {
        fn from(value: TrickyTrickCall) -> Self {
            Self::TrickyTrick(value)
        }
    }
    ///Container type for all return fields from the `checkPassword` function with signature `checkPassword(uint256)` and selector `0x9e4b2e47`
    #[derive(
        Clone,
