...
pub mod swappable_token {
    ...
    pub static SWAPPABLETOKEN_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::core::convert::From<ApproveWithOwnerAndSpenderCall> for SwappableTokenCalls {
