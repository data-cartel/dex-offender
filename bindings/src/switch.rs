...
pub mod switch {
    ...
    impl<M> ::core::fmt::Debug for Switch<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Switch)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> Switch<M> {
        ...
        ///Calls the contract's `flipSwitch` (0x30c13ade) function
        pub fn flip_switch(
            &self,
        ...
        ///Calls the contract's `offSelector` (0x5a2cfa66) function
        pub fn off_selector(
            &self,
        ...
        ///Calls the contract's `switchOn` (0xf9f8f895) function
        pub fn switch_on(&self) -> ::ethers::contract::builders::ContractCall<M, bool> {
            self.0
                .method_hash([249, 248, 248, 149], ())
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `turnSwitchOff` (0x20606e15) function
        ...
        ///Calls the contract's `turnSwitchOn` (0x76227e12) function
    ...
    ///Container type for all input parameters for the `flipSwitch` function with signature `flipSwitch(bytes)` and selector `0x30c13ade`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the `offSelector` function with signature `offSelector()` and selector `0x5a2cfa66`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `switchOn` function with signature `switchOn()` and selector `0xf9f8f895`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `turnSwitchOff` function with signature `turnSwitchOff()` and selector `0x20606e15`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `turnSwitchOn` function with signature `turnSwitchOn()` and selector `0x76227e12`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for SwitchCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <OffSelectorCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TurnSwitchOffCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::TurnSwitchOff(decoded));
            }
            if let Ok(decoded)
                = <TurnSwitchOnCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for SwitchCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::FlipSwitch(element) => ::core::fmt::Display::fmt(element, f),
                Self::OffSelector(element) => ::core::fmt::Display::fmt(element, f),
                Self::SwitchOn(element) => ::core::fmt::Display::fmt(element, f),
                Self::TurnSwitchOff(element) => ::core::fmt::Display::fmt(element, f),
                Self::TurnSwitchOn(element) => ::core::fmt::Display::fmt(element, f),
            }
        }
    }
    impl ::core::convert::From<FlipSwitchCall> for SwitchCalls {
        fn from(value: FlipSwitchCall) -> Self {
            Self::FlipSwitch(value)
        }
    }
    impl ::core::convert::From<OffSelectorCall> for SwitchCalls {
        fn from(value: OffSelectorCall) -> Self {
            Self::OffSelector(value)
        }
    }
    ...
    impl ::core::convert::From<TurnSwitchOffCall> for SwitchCalls {
        fn from(value: TurnSwitchOffCall) -> Self {
            Self::TurnSwitchOff(value)
        }
    }
    impl ::core::convert::From<TurnSwitchOnCall> for SwitchCalls {
        fn from(value: TurnSwitchOnCall) -> Self {
            Self::TurnSwitchOn(value)
        }
    }
    ///Container type for all return fields from the `offSelector` function with signature `offSelector()` and selector `0x5a2cfa66`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `switchOn` function with signature `switchOn()` and selector `0xf9f8f895`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
