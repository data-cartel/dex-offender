...
pub mod telephone {
    ...
    impl<M> ::core::fmt::Debug for Telephone<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Telephone)).field(&self.address()).finish()
        }
    }
