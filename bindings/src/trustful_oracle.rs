...
pub mod trustful_oracle {
    ...
    pub static TRUSTFULORACLE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M: ::ethers::providers::Middleware> TrustfulOracle<M> {
        ...
        ///Calls the contract's `INITIALIZER_ROLE` (0x27df3d3e) function
        ...
        ///Calls the contract's `MIN_SOURCES` (0x54627af0) function
        pub fn min_sources(
            &self,
        ...
        ///Calls the contract's `TRUSTED_SOURCE_ROLE` (0x91691fd9) function
        ...
        ///Calls the contract's `getAllPricesForSymbol` (0x9abd4a25) function
        ...
        ///Calls the contract's `getMedianPrice` (0xd965b308) function
        ...
        ///Calls the contract's `getPriceBySource` (0x29d14710) function
        ...
        ///Calls the contract's `postPrice` (0xbcc82dc4) function
        pub fn post_price(
            &self,
            symbol: ::std::string::String,
        ...
        ///Calls the contract's `setupInitialPrices` (0x66932d86) function
    ...
    for TrustfulOracle<M> {
        fn from(contract: ::ethers::contract::Contract<M>) -> Self {
            Self::new(contract.address(), contract.client())
        }
    }
    ///Custom Error type `NotEnoughSources` with signature `NotEnoughSources()` and selector `0x357809a6`
    #[derive(
        Clone,
    ...
    impl ::ethers::contract::EthLogDecode for TrustfulOracleEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(TrustfulOracleEvents::RoleAdminChangedFilter(decoded));
            }
    ...
    ///Container type for all input parameters for the `INITIALIZER_ROLE` function with signature `INITIALIZER_ROLE()` and selector `0x27df3d3e`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `MIN_SOURCES` function with signature `MIN_SOURCES()` and selector `0x54627af0`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `TRUSTED_SOURCE_ROLE` function with signature `TRUSTED_SOURCE_ROLE()` and selector `0x91691fd9`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `getAllPricesForSymbol` function with signature `getAllPricesForSymbol(string)` and selector `0x9abd4a25`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "getAllPricesForSymbol", abi = "getAllPricesForSymbol(string)")]
    pub struct GetAllPricesForSymbolCall {
        pub symbol: ::std::string::String,
    }
    ///Container type for all input parameters for the `getMedianPrice` function with signature `getMedianPrice(string)` and selector `0xd965b308`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `getPriceBySource` function with signature `getPriceBySource(string,address)` and selector `0x29d14710`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "getPriceBySource", abi = "getPriceBySource(string,address)")]
    ...
    ///Container type for all input parameters for the `postPrice` function with signature `postPrice(string,uint256)` and selector `0xbcc82dc4`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `setupInitialPrices` function with signature `setupInitialPrices(address[],string[],uint256[])` and selector `0x66932d86`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for TrustfulOracleCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <InitializerRoleCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <TrustedSourceRoleCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::TrustedSourceRole(decoded));
            }
            if let Ok(decoded)
                = <GetAllPricesForSymbolCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetAllPricesForSymbol(decoded));
            }
            if let Ok(decoded)
                = <GetMedianPriceCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SetupInitialPricesCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::core::fmt::Display for TrustfulOracleCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::InitializerRole(element) => ::core::fmt::Display::fmt(element, f),
                Self::MinSources(element) => ::core::fmt::Display::fmt(element, f),
                Self::TrustedSourceRole(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetAllPricesForSymbol(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::GetMedianPrice(element) => ::core::fmt::Display::fmt(element, f),
                Self::GetPriceBySource(element) => ::core::fmt::Display::fmt(element, f),
                ...
                Self::PostPrice(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<MinSourcesCall> for TrustfulOracleCalls {
        fn from(value: MinSourcesCall) -> Self {
            Self::MinSources(value)
        }
    }
    ...
    impl ::core::convert::From<PostPriceCall> for TrustfulOracleCalls {
        fn from(value: PostPriceCall) -> Self {
            Self::PostPrice(value)
        }
    }
    ...
    ///Container type for all return fields from the `INITIALIZER_ROLE` function with signature `INITIALIZER_ROLE()` and selector `0x27df3d3e`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `MIN_SOURCES` function with signature `MIN_SOURCES()` and selector `0x54627af0`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `TRUSTED_SOURCE_ROLE` function with signature `TRUSTED_SOURCE_ROLE()` and selector `0x91691fd9`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `getAllPricesForSymbol` function with signature `getAllPricesForSymbol(string)` and selector `0x9abd4a25`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `getMedianPrice` function with signature `getMedianPrice(string)` and selector `0xd965b308`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `getPriceBySource` function with signature `getPriceBySource(string,address)` and selector `0x29d14710`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
