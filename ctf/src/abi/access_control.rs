...
pub mod access_control {
    ...
    pub static ACCESSCONTROL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for AccessControl<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for AccessControlEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(AccessControlEvents::RoleAdminChangedFilter(
                    decoded,
                ));
            }
