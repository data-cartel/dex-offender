...
pub mod access_control_enumerable {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for AccessControlEnumerable<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for AccessControlEnumerableEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(
                    AccessControlEnumerableEvents::RoleAdminChangedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = RoleGrantedFilter::decode_log(log) {
                return Ok(AccessControlEnumerableEvents::RoleGrantedFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = RoleRevokedFilter::decode_log(log) {
                return Ok(AccessControlEnumerableEvents::RoleRevokedFilter(
                    decoded,
                ));
            }
