...
pub mod climber_constants {
    ...
    impl<M> ::core::ops::Deref for ClimberConstants<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target { &self.0 }
    }
    impl<M> ::core::ops::DerefMut for ClimberConstants<M> {
    ...
    impl<M: ::ethers::providers::Middleware> ClimberConstants<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(::ethers::contract::Contract::new(
                address.into(),
                CLIMBERCONSTANTS_ABI.clone(),
                client,
            ))
        }
    }
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for ClimberConstants<M>
    {
