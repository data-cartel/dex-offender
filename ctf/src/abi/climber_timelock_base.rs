...
```*/
    ...
    pub struct getOperationStateReturn {
        #[allow(missing_docs)]
        pub state: <OperationState as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        }
        {
            #[doc(hidden)]
            #[allow(dead_code)]
            type UnderlyingSolTuple<'a> = (OperationState,);
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                <OperationState as alloy::sol_types::SolType>::RustType,
            );
            #[cfg(test)]
            #[allow(dead_code, unreachable_patterns)]
            fn _type_assertion(
        ...
        impl alloy_sol_types::SolCall for getOperationStateCall {
            ...
            type Token<'a> = <Self::Parameters<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            type Return = <OperationState as alloy::sol_types::SolType>::RustType;
            type ReturnTuple<'a> = (OperationState,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<OperationState as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    ///Container for all the [`ClimberTimelockBase`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ClimberTimelockBaseCalls {
        const NAME: &'static str = "ClimberTimelockBaseCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ClimberTimelockBaseCalls>] = &[
                {
                    fn supportsInterface(
                        ...
                        <supportsInterfaceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::supportsInterface)
                    }
                    supportsInterface
                },
                {
                    fn getRoleAdmin(
                        ...
                        <getRoleAdminCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::getRoleAdmin)
                    }
                    getRoleAdmin
                },
                {
                    fn grantRole(
                        ...
                        <grantRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ClimberTimelockBaseCalls::grantRole)
                    }
                    grantRole
                },
                {
                    fn renounceRole(
                        ...
                        <renounceRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::renounceRole)
                    }
                    renounceRole
                },
                {
                    fn getOperationId(
                        ...
                        <getOperationIdCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::getOperationId)
                    }
                    getOperationId
                },
                {
                    fn delay(
                        ...
                        <delayCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ClimberTimelockBaseCalls::delay)
                    }
                    delay
                },
                {
                    fn getOperationState(
                        ...
                        <getOperationStateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::getOperationState)
                    }
                    getOperationState
                },
                {
                    fn hasRole(
                        ...
                        <hasRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ClimberTimelockBaseCalls::hasRole)
                    }
                    hasRole
                },
                {
                    fn DEFAULT_ADMIN_ROLE(
                        ...
                        <DEFAULT_ADMIN_ROLECall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::DEFAULT_ADMIN_ROLE)
                    }
                    DEFAULT_ADMIN_ROLE
                },
                {
                    fn operations(
                        ...
                        <operationsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::operations)
                    }
                    operations
                },
                {
                    fn revokeRole(
                        ...
                        <revokeRoleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ClimberTimelockBaseCalls::revokeRole)
                    }
                    revokeRole
                },
            ];
    ...
    ///Container for all the [`ClimberTimelockBase`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    impl ClimberTimelockBaseEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ClimberTimelockBaseEvents {
        const NAME: &'static str = "ClimberTimelockBaseEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ClimberTimelockBaseEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ClimberTimelockBaseInstance<P, N>>,
    > {
        ClimberTimelockBaseInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ClimberTimelockBaseInstance::<P, N>::deploy_builder(__provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ClimberTimelockBaseInstance<P, N>> {
