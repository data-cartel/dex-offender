...
pub mod crypto_vault {
    ...
    impl ::ethers::core::abi::AbiDecode for CryptoVaultCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) = <SweptTokensRecipientCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
