...
pub mod damn_valuable_token {
    ...
    pub static DAMNVALUABLETOKEN_DEPLOYED_BYTECODE:
        ::ethers::core::types::Bytes =
        ::ethers::core::types::Bytes::from_static(__DEPLOYED_BYTECODE);
    pub struct DamnValuableToken<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DamnValuableToken<M> {
        fn clone(&self) -> Self { Self(::core::clone::Clone::clone(&self.0)) }
    }
    impl<M> ::core::ops::Deref for DamnValuableToken<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target { &self.0 }
    }
    impl<M> ::core::ops::DerefMut for DamnValuableToken<M> {
        fn deref_mut(&mut self) -> &mut Self::Target { &mut self.0 }
    }
    impl<M> ::core::fmt::Debug for DamnValuableToken<M> {
        fn fmt(
            &self,
            f: &mut ::core::fmt::Formatter<'_>,
        ) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DamnValuableToken))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DamnValuableToken<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                DAMNVALUABLETOKEN_ABI.clone(),
                DAMNVALUABLETOKEN_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            DamnValuableTokenEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for DamnValuableToken<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for DamnValuableTokenEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(DamnValuableTokenEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(DamnValuableTokenEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for DamnValuableTokenEvents {
        fn fmt(
            &self,
            f: &mut ::core::fmt::Formatter<'_>,
        ) -> ::core::fmt::Result {
    ...
    impl ::core::convert::From<ApprovalFilter> for DamnValuableTokenEvents {
        fn from(value: ApprovalFilter) -> Self { Self::ApprovalFilter(value) }
    }
    impl ::core::convert::From<TransferFilter> for DamnValuableTokenEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for DamnValuableTokenCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DamnValuableTokenCalls {
    ...
    impl ::core::fmt::Display for DamnValuableTokenCalls {
        fn fmt(
            &self,
            f: &mut ::core::fmt::Formatter<'_>,
        ) -> ::core::fmt::Result {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for DamnValuableTokenCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for DamnValuableTokenCalls {
        fn from(value: AllowanceCall) -> Self { Self::Allowance(value) }
    }
    impl ::core::convert::From<ApproveCall> for DamnValuableTokenCalls {
        fn from(value: ApproveCall) -> Self { Self::Approve(value) }
    }
    impl ::core::convert::From<BalanceOfCall> for DamnValuableTokenCalls {
        fn from(value: BalanceOfCall) -> Self { Self::BalanceOf(value) }
    }
    impl ::core::convert::From<DecimalsCall> for DamnValuableTokenCalls {
        fn from(value: DecimalsCall) -> Self { Self::Decimals(value) }
    }
    impl ::core::convert::From<NameCall> for DamnValuableTokenCalls {
        fn from(value: NameCall) -> Self { Self::Name(value) }
    }
    impl ::core::convert::From<NoncesCall> for DamnValuableTokenCalls {
        fn from(value: NoncesCall) -> Self { Self::Nonces(value) }
    }
    impl ::core::convert::From<PermitCall> for DamnValuableTokenCalls {
        fn from(value: PermitCall) -> Self { Self::Permit(value) }
    }
    impl ::core::convert::From<SymbolCall> for DamnValuableTokenCalls {
        fn from(value: SymbolCall) -> Self { Self::Symbol(value) }
    }
    impl ::core::convert::From<TotalSupplyCall> for DamnValuableTokenCalls {
        fn from(value: TotalSupplyCall) -> Self { Self::TotalSupply(value) }
    }
    impl ::core::convert::From<TransferCall> for DamnValuableTokenCalls {
        fn from(value: TransferCall) -> Self { Self::Transfer(value) }
    }
    impl ::core::convert::From<TransferFromCall> for DamnValuableTokenCalls {
