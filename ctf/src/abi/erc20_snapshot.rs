...
```*/
    ...
    ///Container for all the [`ERC20Snapshot`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ERC20SnapshotCalls {
        const NAME: &'static str = "ERC20SnapshotCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<ERC20SnapshotCalls>] = &[
                {
                    fn name(data: &[u8]) -> alloy_sol_types::Result<ERC20SnapshotCalls> {
                        <nameCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::name)
                    }
                    name
                },
                {
                    fn approve(
                        ...
                        <approveCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::approve)
                    }
                    approve
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::decimals)
                    }
                    decimals
                },
                {
                    fn increaseAllowance(
                        ...
                        <increaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::increaseAllowance)
                    }
                    increaseAllowance
                },
                {
                    fn balanceOfAt(
                        ...
                        <balanceOfAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::balanceOfAt)
                    }
                    balanceOfAt
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::balanceOf)
                    }
                    balanceOf
                },
                {
                ...
                },
                {
                    fn totalSupplyAt(
                        ...
                        <totalSupplyAtCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::totalSupplyAt)
                    }
                    totalSupplyAt
                },
                {
                    fn decreaseAllowance(
                        ...
                        <decreaseAllowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ERC20SnapshotCalls::decreaseAllowance)
                    }
                    decreaseAllowance
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::transfer)
                    }
                    transfer
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20SnapshotCalls::allowance)
                    }
                    allowance
                },
            ];
    ...
    ///Container for all the [`ERC20Snapshot`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ERC20SnapshotEvents {
        const NAME: &'static str = "ERC20SnapshotEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ERC20SnapshotEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
    ...
    /**Creates a new wrapper around an on-chain [`ERC20Snapshot`](self) contract instance.

See the [wrapper's documentation](`ERC20SnapshotInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> ERC20SnapshotInstance<P, N> {
        ERC20SnapshotInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ERC20SnapshotInstance<P, N>>,
    > {
        ERC20SnapshotInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ERC20SnapshotInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`ERC20Snapshot`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ERC20Snapshot`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ERC20SnapshotInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ERC20SnapshotInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20SnapshotInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<ERC20SnapshotInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> ERC20SnapshotInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ERC20SnapshotInstance<P, N> {
