...
pub mod fallout {
    ...
    impl ::ethers::core::abi::AbiDecode for FalloutCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) = <CollectAllocationsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
