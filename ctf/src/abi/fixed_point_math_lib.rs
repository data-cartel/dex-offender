...
pub mod fixed_point_math_lib {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for FixedPointMathLib<M>
    {
        fn from(contract: ::ethers::contract::Contract<M>) -> Self {
            Self::new(contract.address(), contract.client())
        }
    }
    ///Custom Error type `DivFailed` with signature
    /// `DivFailed()` and selector `0x65244e4e`
    #[derive(
        Clone,
    ...
    ///Custom Error type `DivWadFailed` with signature
    /// `DivWadFailed()` and selector `0x7c5f487d`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `ExpOverflow` with signature
    /// `ExpOverflow()` and selector `0xa37bfec9`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `FactorialOverflow` with signature
    /// `FactorialOverflow()` and selector `0xaba0f2a2`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `FullMulDivFailed` with signature
    /// `FullMulDivFailed()` and selector `0xae47f702`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `LnWadUndefined` with signature
    /// `LnWadUndefined()` and selector `0x1615e638`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `Log2Undefined` with signature
    /// `Log2Undefined()` and selector `0x5be3aa5c`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `MulDivFailed` with signature
    /// `MulDivFailed()` and selector `0xad251c27`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    ///Custom Error type `MulWadFailed` with signature
    /// `MulWadFailed()` and selector `0xbac65e5b`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    impl ::ethers::core::abi::AbiDecode for FixedPointMathLibErrors {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) =
                <FactorialOverflow as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <FullMulDivFailed as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
    ...
    impl ::core::convert::From<DivFailed> for FixedPointMathLibErrors {
        fn from(value: DivFailed) -> Self { Self::DivFailed(value) }
    }
    impl ::core::convert::From<DivWadFailed> for FixedPointMathLibErrors {
        fn from(value: DivWadFailed) -> Self { Self::DivWadFailed(value) }
    }
    impl ::core::convert::From<ExpOverflow> for FixedPointMathLibErrors {
        fn from(value: ExpOverflow) -> Self { Self::ExpOverflow(value) }
    }
    ...
    impl ::core::convert::From<LnWadUndefined> for FixedPointMathLibErrors {
        fn from(value: LnWadUndefined) -> Self { Self::LnWadUndefined(value) }
    }
    impl ::core::convert::From<Log2Undefined> for FixedPointMathLibErrors {
        fn from(value: Log2Undefined) -> Self { Self::Log2Undefined(value) }
    }
    impl ::core::convert::From<MulDivFailed> for FixedPointMathLibErrors {
        fn from(value: MulDivFailed) -> Self { Self::MulDivFailed(value) }
    }
    impl ::core::convert::From<MulWadFailed> for FixedPointMathLibErrors {
        fn from(value: MulWadFailed) -> Self { Self::MulWadFailed(value) }
    }
}
