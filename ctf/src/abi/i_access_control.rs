...
pub mod i_access_control {
    ...
    pub static IACCESSCONTROL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IAccessControl<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for IAccessControlEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(IAccessControlEvents::RoleAdminChangedFilter(
                    decoded,
                ));
            }
