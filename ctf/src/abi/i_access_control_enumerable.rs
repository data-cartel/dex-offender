...
pub mod i_access_control_enumerable {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IAccessControlEnumerable<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for IAccessControlEnumerableEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = RoleAdminChangedFilter::decode_log(log) {
                return Ok(
                    IAccessControlEnumerableEvents::RoleAdminChangedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = RoleGrantedFilter::decode_log(log) {
                return Ok(IAccessControlEnumerableEvents::RoleGrantedFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = RoleRevokedFilter::decode_log(log) {
                return Ok(IAccessControlEnumerableEvents::RoleRevokedFilter(
                    decoded,
                ));
            }
