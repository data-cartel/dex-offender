...
pub mod i_beacon_upgradeable {
    ...
    impl<M: ::ethers::providers::Middleware> IBeaconUpgradeable<M> {
        ...
        ///Calls the contract's `implementation`
        /// (0x5c60da1b) function
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IBeaconUpgradeable<M>
    {
    ...
    /// `implementation` function with signature
    /// `implementation()` and selector `0x5c60da1b`
    #[derive(
        Clone,
