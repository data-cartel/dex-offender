...
pub mod i_uniswap_v2_pair {
    ...
    pub static IUNISWAPV2PAIR_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware> IUniswapV2Pair<M> {
        ...
        ///Calls the contract's `MINIMUM_LIQUIDITY`
        /// (0xba9a7a56) function
        ...
        ///Calls the contract's `PERMIT_TYPEHASH`
        /// (0x30adf81f) function
        ...
        ///Calls the contract's `burn` (0x89afcb44)
        /// function
        pub fn burn(
            &self,
        ...
        ///Calls the contract's `getReserves` (0x0902f1ac)
        /// function
        pub fn get_reserves(
            &self,
        ...
        ///Calls the contract's `initialize` (0x485cc955)
        /// function
        pub fn initialize(
            &self,
        ...
        ///Calls the contract's `kLast` (0x7464fc3d)
        /// function
        pub fn k_last(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
        ...
        ///Calls the contract's `mint` (0x6a627842)
        /// function
        pub fn mint(
            &self,
            to: ::ethers::core::types::Address,
        ...
        ///Calls the contract's `price0CumulativeLast`
        /// (0x5909c0d5) function
        ...
        ///Calls the contract's `price1CumulativeLast`
        /// (0x5a3d5493) function
        ...
        ///Calls the contract's `skim` (0xbc25cf77)
        /// function
        pub fn skim(
            &self,
            to: ::ethers::core::types::Address,
        ...
        ///Calls the contract's `swap` (0x022c0d9f)
        /// function
        pub fn swap(
            &self,
            ...
            self.0
                .method_hash(
                    [2, 44, 13, 159],
                    (amount_0_out, amount_1_out, to, data),
                )
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `sync` (0xfff6cae9)
        /// function
        pub fn sync(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<M, ()> {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IUniswapV2Pair<M>
    {
    ...
    impl ::core::convert::From<SyncFilter> for IUniswapV2PairEvents {
        fn from(value: SyncFilter) -> Self { Self::SyncFilter(value) }
    }
    ...
    ///Container type for all input parameters for the
    /// `MINIMUM_LIQUIDITY` function with signature
    /// `MINIMUM_LIQUIDITY()` and selector `0xba9a7a56`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `PERMIT_TYPEHASH` function with signature
    /// `PERMIT_TYPEHASH()` and selector `0x30adf81f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `burn` function with signature `burn(address)` and
    /// selector `0x89afcb44`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `getReserves` function with signature
    /// `getReserves()` and selector `0x0902f1ac`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    /// `initialize(address,address)` and selector
    /// `0x485cc955`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `kLast` function with signature `kLast()` and
    /// selector `0x7464fc3d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `mint` function with signature `mint(address)` and
    /// selector `0x6a627842`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `price0CumulativeLast` function with signature
    /// `price0CumulativeLast()` and selector `0x5909c0d5`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `price1CumulativeLast` function with signature
    /// `price1CumulativeLast()` and selector `0x5a3d5493`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `skim` function with signature `skim(address)` and
    /// selector `0xbc25cf77`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `swap(uint256,uint256,address,bytes)` and selector
    /// `0x022c0d9f`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `sync` function with signature `sync()` and selector
    /// `0xfff6cae9`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    impl ::ethers::core::abi::AbiDecode for IUniswapV2PairCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) =
                <PermitTypehashCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
            ...
            if let Ok(decoded) =
                <GetReservesCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                )
            {
    ...
    impl ::core::convert::From<GetReservesCall> for IUniswapV2PairCalls {
        fn from(value: GetReservesCall) -> Self { Self::GetReserves(value) }
    }
    ...
    impl ::core::convert::From<KlastCall> for IUniswapV2PairCalls {
        fn from(value: KlastCall) -> Self { Self::Klast(value) }
    }
    ...
    impl ::core::convert::From<SkimCall> for IUniswapV2PairCalls {
        fn from(value: SkimCall) -> Self { Self::Skim(value) }
    }
    ...
    impl ::core::convert::From<SyncCall> for IUniswapV2PairCalls {
        fn from(value: SyncCall) -> Self { Self::Sync(value) }
    }
    ...
    /// function with signature `burn(address)` and selector
    /// `0x89afcb44`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    /// function with signature `mint(address)` and selector
    /// `0x6a627842`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
