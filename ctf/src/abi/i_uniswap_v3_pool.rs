...
pub mod i_uniswap_v3_pool {
    ...
    pub static IUNISWAPV3POOL_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware> IUniswapV3Pool<M> {
        ...
        ///Calls the contract's `burn` (0xa34123a7)
        /// function
        pub fn burn(
            &self,
            tick_lower: i32,
        ...
        ///Calls the contract's `collect` (0x4f1eb3d8)
        /// function
        pub fn collect(
            &self,
        ...
        ///Calls the contract's `collectProtocol`
        /// (0x85b66729) function
        ...
        ///Calls the contract's `factory` (0xc45a0155)
        /// function
        pub fn factory(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
        ...
        ///Calls the contract's `feeGrowthGlobal0X128`
        /// (0xf3058399) function
        ...
        ///Calls the contract's `feeGrowthGlobal1X128`
        /// (0x46141319) function
        ...
        ///Calls the contract's `flash` (0x490e6cbc)
        /// function
        pub fn flash(
            &self,
            recipient: ::ethers::core::types::Address,
            ...
            self.0
                .method_hash(
                    [73, 14, 108, 188],
                    (recipient, amount_0, amount_1, data),
                )
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `initialize` (0xf637731d)
        /// function
        pub fn initialize(
            &self,
        ...
        ///Calls the contract's `liquidity` (0x1a686502)
        /// function
        pub fn liquidity(
            &self,
        ...
        ///Calls the contract's `maxLiquidityPerTick`
        /// (0x70cf754a) function
        ...
        ///Calls the contract's `mint` (0x3c8a7d8d)
        /// function
        pub fn mint(
            &self,
            recipient: ::ethers::core::types::Address,
        ...
        ///Calls the contract's `observations` (0x252c09d7)
        /// function
        pub fn observations(
            &self,
        ...
        ///Calls the contract's `observe` (0x883bdbfd)
        /// function
        pub fn observe(
            &self,
        ...
        ///Calls the contract's `positions` (0x514ea4bf)
        /// function
        pub fn positions(
            &self,
            key: [u8; 32],
        ...
        ///Calls the contract's `protocolFees` (0x1ad8b03b)
        /// function
        ...
        ///Calls the contract's `setFeeProtocol`
        /// (0x8206a4d1) function
        pub fn set_fee_protocol(
            ...
            self.0
                .method_hash(
                    [130, 6, 164, 209],
                    (fee_protocol_0, fee_protocol_1),
                )
                .expect("method not found (this should never happen)")
        }
        ///Calls the contract's `slot0` (0x3850c7bd)
        /// function
        pub fn slot_0(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
        ...
        ///Calls the contract's `snapshotCumulativesInside`
        /// (0xa38807f2) function
        ...
        ///Calls the contract's `swap` (0x128acb08)
        /// function
        pub fn swap(
            &self,
            recipient: ::ethers::core::types::Address,
        ...
        ///Calls the contract's `tickBitmap` (0x5339c296)
        /// function
        pub fn tick_bitmap(
            &self,
            word_position: i16,
        ...
        ///Calls the contract's `tickSpacing` (0xd0c93a7c)
        /// function
        pub fn tick_spacing(
            &self,
        ...
        ///Calls the contract's `ticks` (0xf30dba93)
        /// function
        pub fn ticks(
            &self,
            tick: i32,
        ...
        ///Calls the contract's `token0` (0x0dfe1681)
        /// function
        pub fn token_0(
            &self,
        ) -> ::ethers::contract::builders::ContractCall<
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IUniswapV3Pool<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for IUniswapV3PoolEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = CollectProtocolFilter::decode_log(log) {
                return Ok(IUniswapV3PoolEvents::CollectProtocolFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<BurnFilter> for IUniswapV3PoolEvents {
        fn from(value: BurnFilter) -> Self { Self::BurnFilter(value) }
    }
    impl ::core::convert::From<CollectFilter> for IUniswapV3PoolEvents {
        fn from(value: CollectFilter) -> Self { Self::CollectFilter(value) }
    }
    ...
    impl ::core::convert::From<FlashFilter> for IUniswapV3PoolEvents {
        fn from(value: FlashFilter) -> Self { Self::FlashFilter(value) }
    }
    ...
    impl ::core::convert::From<MintFilter> for IUniswapV3PoolEvents {
        fn from(value: MintFilter) -> Self { Self::MintFilter(value) }
    }
    ...
    impl ::core::convert::From<SwapFilter> for IUniswapV3PoolEvents {
        fn from(value: SwapFilter) -> Self { Self::SwapFilter(value) }
    }
    ///Container type for all input parameters for the
    /// `burn` function with signature
    /// `burn(int24,int24,uint128)` and selector
    /// `0xa34123a7`
    #[derive(
        Clone,
    ...
    ///Container type for all input parameters for the
    /// `collect` function with signature
    /// `collect(address,int24,int24,uint128,uint128)` and
    /// selector `0x4f1eb3d8`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    #[ethcall(
        name = "collect",
        abi = "collect(address,int24,int24,uint128,uint128)"
    )]
    ...
    ///Container type for all input parameters for the
    /// `collectProtocol` function with signature
    /// `collectProtocol(address,uint128,uint128)` and
    /// selector `0x85b66729`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `factory` function with signature `factory()` and
    /// selector `0xc45a0155`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `fee` function with signature `fee()` and selector
    /// `0xddca3f43`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    pub struct FeeCall;
    ///Container type for all input parameters for the
    /// `feeGrowthGlobal0X128` function with signature
    ...
    ///Container type for all input parameters for the
    /// `feeGrowthGlobal1X128` function with signature
    ...
    ///Container type for all input parameters for the
    /// `flash` function with signature
    /// `flash(address,uint256,uint256,bytes)` and selector
    /// `0x490e6cbc`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `increaseObservationCardinalityNext` function with
    /// signature `increaseObservationCardinalityNext(uint16)`
    /// and selector `0x32148f67`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `liquidity` function with signature `liquidity()`
    /// and selector `0x1a686502`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the
    /// `maxLiquidityPerTick` function with signature
    ...
    /// `mint(address,int24,int24,uint128,bytes)` and
    /// selector `0x3c8a7d8d`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `observations` function with signature
    ...
    ///Container type for all input parameters for the
    /// `observe` function with signature
    ...
    ///Container type for all input parameters for the
    /// `positions` function with signature
    ...
    ///Container type for all input parameters for the
    /// `protocolFees` function with signature
    ...
    ///Container type for all input parameters for the
    /// `setFeeProtocol` function with signature
    /// `setFeeProtocol(uint8,uint8)` and selector
    /// `0x8206a4d1`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `slot0` function with signature `slot0()` and
    /// selector `0x3850c7bd`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `snapshotCumulativesInside` function with signature
    /// `snapshotCumulativesInside(int24,int24)` and
    /// selector `0xa38807f2`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    /// `swap(address,bool,int256,uint160,bytes)` and
    /// selector `0x128acb08`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `tickBitmap` function with signature
    ...
    ///Container type for all input parameters for the
    /// `tickSpacing` function with signature
    ...
    ///Container type for all input parameters for the
    /// `ticks` function with signature `ticks(int24)` and
    /// selector `0xf30dba93`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    ///Container type for all input parameters for the
    /// `token0` function with signature `token0()` and
    /// selector `0x0dfe1681`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
    ...
    impl ::core::convert::From<CollectCall> for IUniswapV3PoolCalls {
        fn from(value: CollectCall) -> Self { Self::Collect(value) }
    }
    ...
    impl ::core::convert::From<FactoryCall> for IUniswapV3PoolCalls {
        fn from(value: FactoryCall) -> Self { Self::Factory(value) }
    }
    impl ::core::convert::From<FeeCall> for IUniswapV3PoolCalls {
        fn from(value: FeeCall) -> Self { Self::Fee(value) }
    }
    ...
    impl ::core::convert::From<FlashCall> for IUniswapV3PoolCalls {
        fn from(value: FlashCall) -> Self { Self::Flash(value) }
    }
    ...
    impl ::core::convert::From<LiquidityCall> for IUniswapV3PoolCalls {
        fn from(value: LiquidityCall) -> Self { Self::Liquidity(value) }
    }
    ...
    impl ::core::convert::From<ObservationsCall> for IUniswapV3PoolCalls {
        fn from(value: ObservationsCall) -> Self { Self::Observations(value) }
    }
    impl ::core::convert::From<ObserveCall> for IUniswapV3PoolCalls {
        fn from(value: ObserveCall) -> Self { Self::Observe(value) }
    }
    impl ::core::convert::From<PositionsCall> for IUniswapV3PoolCalls {
        fn from(value: PositionsCall) -> Self { Self::Positions(value) }
    }
    impl ::core::convert::From<ProtocolFeesCall> for IUniswapV3PoolCalls {
        fn from(value: ProtocolFeesCall) -> Self { Self::ProtocolFees(value) }
    }
    ...
    impl ::core::convert::From<Slot0Call> for IUniswapV3PoolCalls {
        fn from(value: Slot0Call) -> Self { Self::Slot0(value) }
    }
    ...
    impl ::core::convert::From<TickBitmapCall> for IUniswapV3PoolCalls {
        fn from(value: TickBitmapCall) -> Self { Self::TickBitmap(value) }
    }
    impl ::core::convert::From<TickSpacingCall> for IUniswapV3PoolCalls {
        fn from(value: TickSpacingCall) -> Self { Self::TickSpacing(value) }
    }
    impl ::core::convert::From<TicksCall> for IUniswapV3PoolCalls {
        fn from(value: TicksCall) -> Self { Self::Ticks(value) }
    }
    impl ::core::convert::From<Token0Call> for IUniswapV3PoolCalls {
        fn from(value: Token0Call) -> Self { Self::Token0(value) }
    }
    impl ::core::convert::From<Token1Call> for IUniswapV3PoolCalls {
        fn from(value: Token1Call) -> Self { Self::Token1(value) }
    }
    ///Container type for all return fields from the `burn`
    /// function with signature `burn(int24,int24,uint128)`
    /// and selector `0xa34123a7`
    #[derive(
        Clone,
    ...
    ///Container type for all return fields from the `fee`
    /// function with signature `fee()` and selector
    /// `0xddca3f43`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
    ...
    pub struct ObserveReturn {
        ...
        pub seconds_per_liquidity_cumulative_x12_8s:
            ::std::vec::Vec<::ethers::core::types::U256>,
    }
    ///Container type for all return fields from the
    /// `positions` function with signature
    ...
    ///Container type for all return fields from the `swap`
    /// function with signature
    /// `swap(address,bool,int256,uint160,bytes)` and
    /// selector `0x128acb08`
    #[derive(
