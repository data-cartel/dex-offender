...
pub mod i_uniswap_v3_pool_events {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IUniswapV3PoolEvents<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for IUniswapV3PoolEventsEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = CollectProtocolFilter::decode_log(log) {
                return Ok(IUniswapV3PoolEventsEvents::CollectProtocolFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = InitializeFilter::decode_log(log) {
                return Ok(IUniswapV3PoolEventsEvents::InitializeFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = SetFeeProtocolFilter::decode_log(log) {
                return Ok(IUniswapV3PoolEventsEvents::SetFeeProtocolFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<CollectProtocolFilter>
    ...
    impl ::core::convert::From<SetFeeProtocolFilter>
        for IUniswapV3PoolEventsEvents
    {
