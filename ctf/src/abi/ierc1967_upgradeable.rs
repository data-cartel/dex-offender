...
```*/
    ...
    ///Container for all the [`IERC1967Upgradeable`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    ...
    impl IERC1967UpgradeableEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IERC1967UpgradeableEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IERC1967UpgradeableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`IERC1967Upgradeable`](self) contract instance.

See the [wrapper's documentation](`IERC1967UpgradeableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IERC1967UpgradeableInstance<P, N> {
        IERC1967UpgradeableInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IERC1967UpgradeableInstance<P, N>>,
    > {
        IERC1967UpgradeableInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IERC1967UpgradeableInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IERC1967Upgradeable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IERC1967Upgradeable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IERC1967UpgradeableInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IERC1967UpgradeableInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC1967UpgradeableInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IERC1967UpgradeableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IERC1967UpgradeableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IERC1967UpgradeableInstance<P, N> {
            IERC1967UpgradeableInstance {
