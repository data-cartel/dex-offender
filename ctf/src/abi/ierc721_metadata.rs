...
pub mod ierc721_metadata {
    ...
    pub static IERC721METADATA_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for IERC721Metadata<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for IERC721MetadataEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = ApprovalForAllFilter::decode_log(log) {
                return Ok(IERC721MetadataEvents::ApprovalForAllFilter(
                    decoded,
                ));
            }
