...
pub mod legacy_token {
    ...
    impl ::ethers::core::abi::AbiDecode for LegacyTokenCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) = <DelegateToNewContractCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
