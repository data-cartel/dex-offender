...
See the [wrapper's documentation](`OwnedInstance`) for more details.*/
    ...
    >(address: alloy_sol_types::private::Address, __provider: P) -> OwnedInstance<P, N> {
        OwnedInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        OwnedInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        OwnedInstance::<P, N>::deploy_builder(__provider)
    }
