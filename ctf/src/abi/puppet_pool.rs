...
pub mod puppet_pool {
    ...
    impl ::ethers::core::abi::AbiDecode for PuppetPoolCalls {
        ...
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError>
        {
            ...
            if let Ok(decoded) = <CalculateDepositRequiredCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
