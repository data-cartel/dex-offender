...
pub mod swappable_token_two {
    ...
    pub static SWAPPABLETOKENTWO_DEPLOYED_BYTECODE:
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for SwappableTokenTwo<M>
    {
