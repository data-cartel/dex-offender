...
pub mod trustful_oracle_initializer {
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for TrustfulOracleInitializer<M>
    {
