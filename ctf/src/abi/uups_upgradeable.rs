...
pub mod uups_upgradeable {
    ...
    pub static UUPSUPGRADEABLE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    impl<M: ::ethers::providers::Middleware>
        From<::ethers::contract::Contract<M>> for UUPSUpgradeable<M>
    {
    ...
    impl ::ethers::contract::EthLogDecode for UUPSUpgradeableEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = BeaconUpgradedFilter::decode_log(log) {
                return Ok(UUPSUpgradeableEvents::BeaconUpgradedFilter(
                    decoded,
                ));
            }
